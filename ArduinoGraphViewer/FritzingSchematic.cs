...
namespace ArduinoGraphViewer
{
    ...
    public partial class FritzingSchematic : Form, IDisposable
    {
        #region VARS
        ...
        private void BtnGetFritzingFile_Click(object sender, EventArgs e)
        {
            try
            {
                using (SaveFileDialog sfd = new SaveFileDialog())
                {
                    ...
                    sfd.Filter = "Fritzing Files (*.fzz)|*.fzz|All files (*.*)|*.*";
                    sfd.FilterIndex = 1;
